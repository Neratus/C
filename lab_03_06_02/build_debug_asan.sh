...
clang -c -std=c99 -Wall -Werror -Wpedantic -Wextra -Wfloat-equal -Wfloat-conversion -fsanitize=address -fno-omit-frame-pointer -g3 -Wvla -O0 matrix_io.c
...
clang -o app.exe -g3 main.o func.o matrix_io.o -lm -fsanitize=address