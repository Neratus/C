...
START_TEST(test_min_several_pairs)
{
    test_pair_t tests[] =
    {
        {"Hello", 1},
...
Suite* min_suite(void)
{
    ...
    tcase_add_test(tc_pos, test_min_one_pair);
    tcase_add_test(tc_pos, test_min_several_pairs);

    suite_add_tcase(s, tc_pos);

    tc_neg = tcase_create("neg");
    tcase_add_test(tc_neg, test_min_null);
